...
import { WHATSAPP_NUMBER, routes } from "./site";

// routes, branches and SEO data live in ./site.js so the build can read them.
export { WHATSAPP_NUMBER, routes, branches } from "./site";
